...
namespace EchoBot1
{
    ...
    public class EchoBot1Bot : IBot
    {
        ...
        private IQnAMakerServices _qnaMakerServices;
        ...
        public EchoBot1Bot(ConversationState conversationState, ILoggerFactory loggerFactory, IQnAMakerServices qnAMakerServices)
        {
